...
#In this list we can see that depedening on how the function is defined there will be very different results.
#I was unable to obtain the file that worked so I had to tinker with this file.
#From studying the script I can see where crucial changes are to alter the code. 
#For instance based on how the Data vector is defined, as well as the Ptheta vector.